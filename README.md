...
### Installation
I Create the project with `npm create vite@latest` and into in the project using `cd countdown` and below have the link of the things that I used in this project or that you can use:
...
## Referência
- [Youtube] - PROJETO DE CONTAGEM REGRESSIVA COM REACT JS - PROJETO DE REACT PARA INICIANTES | Matheus Battisti - Hora de Codar - (https://www.youtube.com/watch?v=uYSV4w1FFnE&list=PLnDvRpP8BneyVA0SZ2okm-QBojomniQVO&index=49)
